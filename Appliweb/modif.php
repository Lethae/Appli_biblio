...
//Add auteur
$name 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['name']) ? $_POST['name'] : NULL)) ;
$surname 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['surname']) ? $_POST['surname'] : NULL)) ;
$dateN 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['dateN']) ? $_POST['dateN'] : NULL)) ;

//Add livre 
$title 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['title']) ? $_POST['title'] : NULL)) ;
$description	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['description']) ? $_POST['description'] : NULL)) ;
$dateP 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['dateP']) ? $_POST['dateP'] : NULL)) ;

//Add editeur
$nameed 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['nameed']) ? $_POST['nameed'] : NULL)) ;

//Update auteur
$name_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['name_u']) ? $_POST['name_u'] : NULL)) ;
$surname_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['surname_u']) ? $_POST['surname_u'] : NULL)) ;
$dateN_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['dateN_u']) ? $_POST['dateN_u'] : NULL)) ;

//Update livre 
$title_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['title_u']) ? $_POST['title_u'] : NULL)) ;
$id_auteur_u	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['id_auteur_u']) ? $_POST['id_auteur_u'] : NULL)) ;
$id_editeur_u	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['id_editeur_u']) ? $_POST['id_editeur_u'] : NULL)) ;
$description_u	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['description_u']) ? $_POST['description_u'] : NULL)) ;
$dateP_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['dateP_u']) ? $_POST['dateP_u'] : NULL)) ;

//Update editeur
$nameed_u 	= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['nameed_u']) ? $_POST['nameed_u'] : NULL)) ;
...
//Update user
$login_u 		= htmlentities(mysqli_real_escape_string($connexion,isset($_POST['login_u']) ? $_POST['login_u'] : NULL)) ;
